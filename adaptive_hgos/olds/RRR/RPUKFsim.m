...
odefun = @(t,x) RPUKF(t, tdist, dist, x, lam, a, b, k, R, Q);
...
set(p1,'xtick',ticks)
xticklabels('')
ylabel('$\tilde{x}_{\mathrm{UKO}}$','interpreter',...
    'latex','fontsize',fs)
grid on
box on
set(gca,'TickLabelInterpreter','latex')
l1 = legend('$\tilde{x}_{\mathrm{UKO},1}$',...
    '$\tilde{x}_{\mathrm{UKO},2}$',...
    '$\tilde{x}_{\mathrm{UKO},3}$','interpreter','latex','fontsize',fs,...
    'location','eastOutside');

p2 = subplot(2,1,2);
plot(t, hlam - lam', 'linewidth', 1)
ylabel('$\tilde{\lambda}_{\mathrm{UKO}}$','interpreter',...
    'latex','fontsize',fs)
xlim([0 Tf])
ylim([-0.7 0.2])
set(p2,'xtick',ticks)
...
set(gca,'TickLabelInterpreter','latex')
% xlabel('$t$','interpreter','latex','fontsize',fs)
l2 = legend('$\tilde{\lambda}_{\mathrm{UKO},1}$',...
    '$\tilde{\lambda}_{\mathrm{UKO},2}$'...
